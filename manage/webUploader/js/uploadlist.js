(function ($) {
    ...
    $(function () {
        ...
        uploader = WebUploader.create({
			...
			formData:{
				selectClass:upload_data_arr[0],
				title:upload_data_arr[1],
				upload_sort:upload_data_arr[2],
				small_img_style:upload_data_arr[3],
				small_img_width:upload_data_arr[4],
				small_img_height:upload_data_arr[5],
			},
            dnd: '#dndArea',
            paste: '#uploader',
		...
		uploader.on( 'uploadAccept', function( file, response ) {
			...
			if(response._raw.replace(/[\r\n]/g,"") != ""){
				...
				if (typeof(response.error) != "undefined" ) {
					...
					window.location.href="info.php?msg="+ response.error.message +"&url=javascript:history.back();"; 
					return false;
				}else{
					return false;
				};

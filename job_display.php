				...
				<form action="" id="form_job" name="form_job" method="post" onSubmit="return check(this);">
					<ul>
						<li class="field">
							<div class="input">
								<label>姓名：</label>
								<input name="name" type="text" size="20" maxlength="50" class="text" /><font color="#FF0000"> *</font>
							</div>
						</li>
						<li class="field">
							<div class="input">
						...
						<li class="field">
							<div class="input">
								<label>电话：</label>
								<input id="phone" name="phone" type="text" size="20" maxlength="50" class="text" /><font color="#FF0000"> *</font>
							</div>
						</li>
						<li class="field">
							<div class="input">
